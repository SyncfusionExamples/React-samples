...
var Wizard = (function (_super) {
    ...
    Wizard.prototype.tabSelected = function (e) {
        if (e.isSwiped) {
            e.cancel = true;
        }
    };
        ...
        return (React.createElement("div", null,
            React.createElement("div", { className: "col-lg-12 control-section e-tab-section" },
                React.createElement("div", { className: "e-sample-resize-container" },
                    React.createElement("div", { id: "booking", style: hideDiv },
                        ...
                        React.createElement("div", { className: "responsive-align" },
                            ...
                            React.createElement("div", { className: "row" },
                                React.createElement("div", { className: "col-xs-6 col-sm-6 col-lg-6 col-md-6 search-item" },
                                    React.createElement(ej2_react_calendars_1.DatePickerComponent, { ref: function (calendar) { return _this.journeyDate = calendar; }, width: '100%', placeholder: 'Journey Date', floatLabelType: 'Auto', min: this.dateMin, max: this.dateMax, value: this.dateValue })),
                                React.createElement("div", { className: "col-xs-6 col-sm-6 col-lg-6 col-md-6 search-item" },
                    ...
                    React.createElement("div", { id: "selectTrain", style: hideDiv },
                        React.createElement("div", { className: "wizard-title" }, "Select the train from the list "),
                        React.createElement(ej2_react_grids_1.GridComponent, { ref: function (grid) { return _this.availTrainGrid = grid; }, width: '100%', rowSelected: this.trainSelected.bind(this) },
                    ...
                    React.createElement("div", { id: "details", style: hideDiv },
                    ...
                    React.createElement("div", { id: "confirm", style: hideDiv },
                        React.createElement("div", { className: "tab-title1 wizard-title" }, "Confirm the details and proceed"),
                        React.createElement(ej2_react_grids_1.GridComponent, { ref: function (grid) { return _this.ticketDetailGrid = grid; }, width: '100%' },
                            React.createElement(ej2_react_grids_1.ColumnsDirective, null,
                                React.createElement(ej2_react_grids_1.ColumnDirective, { field: "TrainNo", headerText: "Train No", width: 120, type: "number" }),
                    ...
                    React.createElement(ej2_react_navigations_1.TabComponent, { id: "tab-wizard", ref: function (tab) { return _this.tab = tab; }, heightAdjustMode: "None", height: 390, selecting: this.tabSelected.bind(this) },
                        React.createElement(ej2_react_navigations_1.TabItemsDirective, null,
                            React.createElement(ej2_react_navigations_1.TabItemDirective, { header: this.headerText[0], content: "#booking" }),
                            React.createElement(ej2_react_navigations_1.TabItemDirective, { header: this.headerText[1], content: "#selectTrain", disabled: true }),
                            React.createElement(ej2_react_navigations_1.TabItemDirective, { header: this.headerText[2], content: "#details", disabled: true }),
                            React.createElement(ej2_react_navigations_1.TabItemDirective, { header: this.headerText[3], content: "#confirm", disabled: true }))),
                    React.createElement(ej2_react_popups_1.DialogComponent, { ref: function (dialog) { return _this.alertDlg = dialog; }, header: "Success", width: 250, isModal: true, visible: false, showCloseIcon: true, content: 'Your payment successfully processed', target: this.dlgTarget, buttons: this.dlgButtons, created: this.dlgCreated }))),
            ...
            React.createElement("div", { id: "description" },
                React.createElement("p", null,
                    ...
                    React.createElement("a", { target: "_blank", href: "http://ej2.syncfusion.com/documentation/tab/api-tab.html?lang=typescript#enabletab" }, "enableTab"),
                    " method."),
                ...
                React.createElement("p", null,
                    ...
                    React.createElement("a", { target: "_blank", href: "http://ej2.syncfusion.com/documentation/tab/getting-started.html" }, " documentation"),
                    " section."))));
    };
    return Wizard;
