...
var Data = (function (_super) {
    ...
    function Data() {
        ...
        _this.customerData = new ej2_data_1.DataManager({
            ...
            adaptor: new ej2_data_1.ODataAdaptor,
            crossDomain: true
        });
        // bind the Query instance to query property
        _this.query = new ej2_data_1.Query().select(['ContactName', 'CustomerID']);
        // maps the remote data column to fields property
        _this.remoteFields = { text: 'ContactName', value: 'CustomerID' };
                ...
                React.createElement("div", { className: 'col-lg-9' },
                    ...
                    React.createElement("div", { className: 'col-lg-6' },
                        React.createElement("div", { id: "remote" },
                            ...
                            React.createElement(ej2_react_dropdowns_1.ComboBoxComponent, { id: "customers", dataSource: this.customerData, ref: function (combobox) { _this.remoteDataObj = combobox; }, sortOrder: "Ascending", query: this.query, fields: this.remoteFields, placeholder: "Select a customer", autofill: true, popupHeight: "220px" })))),
