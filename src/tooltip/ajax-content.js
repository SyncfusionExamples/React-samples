    ...
    AjaxContentTooltip.prototype.render = function () {
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                ...
                React.createElement(ej2_react_popups_1.TooltipComponent, { className: "e-prevent-select", content: this.state.content, target: "#countrylist [title]", position: 'RightCenter', beforeRender: this.onBeforeRender.bind(this) },
