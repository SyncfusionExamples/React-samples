        ...
        return (React.createElement("div", { className: 'control-pane format' },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null,
                    "The TimePicker has been customized with 24-hour ",
                    React.createElement("code", null, "format"),
                    " with 60 minutes ",
                    React.createElement("code", null, "interval"),
                    ". Click the TimePicker icon to a select a time from 00:00 to 23:00 from the TimePicker popup.")),
            React.createElement("div", { id: 'description' },
                React.createElement("p", null,
                    "TimePicker provides an option to customize the display format of the time value using the",
                    React.createElement("a", { href: "https://ej2.syncfusion.com/react/documentation/timepicker/getting-started.html#setting-the-time-format", target: "_blank" }, "format"),
                    "property. It accepts ",
                ...
                React.createElement("p", null,
                    ...
                    React.createElement("a", { href: "https://ej2.syncfusion.com/react/documentation/base/internationalization.html#custom-formats", target: "_blank" }, " Parsing and formatting"),
                ...
                React.createElement("p", null,
                    ...
                    React.createElement("a", { href: "https://ej2.syncfusion.com/react/documentation/timepicker/getting-started.html#create-a-simple-timepicker", target: "_blank" }, " documentation section"),
                    "."))));
    };
    return Format;
