...
export const heatmapCategory = {"default":{"name":"Default Functionalities","category":"HeatMap"},"calendar-heatmap":{"name":"Calendar Heatmap","category":"HeatMap"},"bubble-types":{"name":"Bubble Types","category":"Bubble Heatmap"},"color-and-size-attributes":{"name":"Color and Size Attributes","category":"Bubble Heatmap"},"array-row":{"name":"Row","category":"Data Binding"},"array-cell":{"name":"Cell","category":"Data Binding"},"row-json-binding":{"name":"JSON Row","category":"Data Binding"},"cell-json-binding":{"name":"JSON Cell","category":"Data Binding"},"empty-points":{"name":"Empty points","category":"Features"},"inversed-axis":{"name":"Inversed Axis","category":"Features"},"opposed-axis":{"name":"Opposed Axis","category":"Features"},"legend":{"name":"Legend Placement","category":"Features"},"large-data":{"name":"Large Data","category":"Features"},"palette":{"name":"Palette Mode","category":"Features"},"render-mode":{"name":"Rendering mode","category":"Features"},"tooltip-template":{"name":"Tooltip Template","category":"Features"},"defaultSample":"heatmap/default"}