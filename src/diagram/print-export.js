...
var SAMPLE_CSS = "   .e-bigger #toolbar_default .e-icons.e-caret,\n#toolbar_default .e-icons.e-caret {\n    font-size: 12px;\n    margin-right: 0px;\n}\n\n#custombtn {\n    padding: 4px 0px 2px 4px;\n}";
        ...
        return (React.createElement("div", { className: "control-pane" },
            ...
            React.createElement("div", { className: "control-section" },
                React.createElement("div", { className: "content-wrapper", style: { width: "100%" } },
                    React.createElement(ej2_react_navigations_1.ToolbarComponent, { style: { width: "100%", height: "10%", marginTop: "10px" }, id: "toolbar_default", clicked: onItemClick },
