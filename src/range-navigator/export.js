...
var Export = (function (_super) {
                ...
                React.createElement("div", { className: 'col-md-9' },
                    ...
                    React.createElement("div", { className: "row" },
                        React.createElement(ej2_react_charts_1.ChartComponent, { id: 'charts', ref: function (chart) { return _this.chartInstance = chart; }, style: { textAlign: "center" }, primaryXAxis: {
                            ...
                            React.createElement(ej2_react_charts_1.Inject, { services: [ej2_react_charts_1.SplineAreaSeries, ej2_react_charts_1.DateTime, ej2_react_charts_1.Tooltip] }),
    ...
    Export.prototype.changed = function (args) {
    ...
    ;
    Export.prototype.chartLoad = function (args) {
    ...
    ;
    Export.prototype.rangeLoad = function (args) {
        var selectedTheme = location.hash.split('/')[1];
        selectedTheme = selectedTheme ? selectedTheme : 'Material';
        args.rangeNavigator.theme = (selectedTheme.charAt(0).toUpperCase() + selectedTheme.slice(1));
    };
    ;
    Export.prototype.exportClick = function (e) {
        var fileName = document.getElementById('fileName').value;
        this.rangeInstance.export(this.mode.value, fileName, null, [this.rangeInstance, this.chartInstance]);
    };
    Export.prototype.printClick = function (e) {
