...
var helper_1 = require("@syncfusion/ej2-charts/src/common/utils/helper");
var ej2_base_1 = require("@syncfusion/ej2-base");
var sample_base_1 = require("../common/sample-base");
var helper_2 = require("@syncfusion/ej2-svg-base/src/tooltip/helper");
...
var StockChart = (function (_super) {
    ...
    StockChart.prototype.mouseMove = function (args) {
        if (!helper_1.withInBounds(this.chart1.mouseX, this.chart1.mouseY, this.chart1.chartAxisLayoutPanel.seriesClipRect)) {
    ...
    StockChart.prototype.rangeLoaded = function (args) {
        var element = helper_2.getElement('rangenavigator_Secondary_Element');
        ...
        if (this.rangenavigator1) {
            ...
            var element1 = helper_2.getElement('stockRange');
...
function removeSecondaryElement() {
    setTimeout(function () {
        if (helper_2.getElement("annotation")) {
            ej2_base_1.remove(helper_2.getElement("annotation"));
        }
    }, 2000);
}
