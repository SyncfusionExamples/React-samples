        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null,
                    ...
                    " date time format. To change this current date format, go to the properties panel at the right side and select a date format from the dropdown options.")),
            React.createElement("div", { id: 'description' },
                ...
                React.createElement("p", null,
                    ...
                    React.createElement("a", { href: "https://ej2.syncfusion.com/react/documentation/daterangepicker/globalization.html#date-format", target: "_blank" }, " documentation section"),
                    "."))));
    };
    return Format;
