    ...
    Presets.prototype.render = function () {
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "Click the DateRangePicker icon to view and select the list of custom preset ranges. Select the custom range option which is provided at the end of this list to open date range picker popup calendar for selecting custom ranges.")),
            React.createElement("div", { id: 'description' },
                ...
                React.createElement("p", null,
                    ...
                    React.createElement("a", { href: "https://ej2.syncfusion.com/react/documentation/daterangepicker/customization.html#preset-ranges", target: "_blank" }, "documentation section"),
                    "."))));
    };
    return Presets;
