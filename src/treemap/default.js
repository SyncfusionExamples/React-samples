...
var car_sale_1 = require("./treemap-data/car-sale");
        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_treemap_1.TreeMapComponent, { itemClick: this.itemMove.bind(this), itemMove: this.itemMove.bind(this), load: this.load.bind(this), id: 'treemap-container', titleSettings: {
                        ...
                        textStyle: { size: '15px' }
                    }, rangeColorValuePath: 'Sales', format: "n", useGroupingSeparator: true, dataSource: car_sale_1.CarSales, legendSettings: {
                        visible: true,
                        position: 'Top',
                        shape: 'Rectangle'
