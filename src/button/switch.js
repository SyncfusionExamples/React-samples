        ...
        return (React.createElement("div", { className: "control-pane" },
            ...
            React.createElement("div", { id: "description" },
                ...
                React.createElement("p", null,
                    ...
                    React.createElement("a", { target: "_blank", href: "http://ej2.syncfusion.com/react/documentation/switch/api-switchComponent.html#checked-boolean" },
                        React.createElement("code", null, "checked")),
                    " property, and disabled state is achieved by using the ",
                    React.createElement("a", { target: "_blank", href: "http://ej2.syncfusion.com/react/documentation/switch/api-switchComponent.html#disabled-boolean" },
                        React.createElement("code", null, "disabled")),
                    " property."),
                React.createElement("p", null,
                    "More information on Switch can be found in the ",
                    React.createElement("a", { target: "_blank", href: "http://ej2.syncfusion.com/react/documentation/switch/getting-started.html" }, "documentation section"),
                    "."))));
    };
    return Switch;
