                ...
                React.createElement("div", { className: 'progress-button-section' },
                    React.createElement("div", { id: 'progress-button-control' },
                        ...
                        React.createElement("div", { className: 'row' },
                            React.createElement("div", { className: "col-xs-6 col-sm-6 col-lg-6 col-md-6" },
                                React.createElement("div", { className: "col-xs-12 col-sm-12 col-lg-6 col-md-6" },
                                    React.createElement(ej2_react_splitbuttons_1.ProgressButtonComponent, { id: "roundbtn", spinSettings: this.spinCenter, animationSettings: this.zoomOut, cssClass: "e-round e-small e-success", iconCss: "e-icons e-play-icon" })),
                                React.createElement("div", { className: "col-xs-12 col-sm-12 col-lg-6 col-md-6" },
                        ...
                        React.createElement("div", { className: 'row' },
                            ...
                            React.createElement("div", { className: "col-xs-6 col-sm-6 col-lg-6 col-md-6" },
                                React.createElement("div", { className: "col-xs-12 col-sm-12 col-lg-6 col-md-6" },
                                    React.createElement(ej2_react_splitbuttons_1.ProgressButtonComponent, { content: "Download", enableProgress: true, duration: this.duration, cssClass: "e-hide-spinner e-progress-top", iconCss: "e-icons e-download-icon" })),
                                React.createElement("div", { className: "col-xs-12 col-sm-12 col-lg-6 col-md-6" },
            ...
            React.createElement("div", { id: "description" },
                ...
                React.createElement("p", null,
                    ...
                    React.createElement("code", null,
                        React.createElement("a", { target: "_blank", href: "http://ej2.syncfusion.com/react/documentation/progress-button/api-progressButton.html#content" }, "content,")),
                    React.createElement("code", null,
                        React.createElement("a", { target: "_blank", href: "http://ej2.syncfusion.com/react/documentation/progress-button/api-progressButton.html#cssClass" }, "cssClass,")),
                    "and",
                    React.createElement("code", null,
                        React.createElement("a", { target: "_blank", href: "http://ej2.syncfusion.com/react/documentation/progress-button/api-progressButton.html#enableProgress" }, "enableProgress")),
                    "property."),
                React.createElement("p", null,
                    "More information about progress button can be found in this",
                    React.createElement("a", { target: "_blank", href: "http://ej2.syncfusion.com/react/documentation/progress-button/getting-started.html" }, "documentation section"),
                    "."))));
    };
