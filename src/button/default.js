        ...
        return (React.createElement("div", { className: 'control-pane' },
                ...
                React.createElement("div", { className: 'button-section' },
                    React.createElement("div", { id: 'button-control' },
                        React.createElement("div", { className: 'row' },
                            ...
                            React.createElement("div", { className: "col-xs-6 col-sm-6 col-lg-6 col-md-6" },
                                React.createElement("div", { className: "col-xs-12 col-sm-12 col-lg-6 col-md-6" },
                                    React.createElement(ej2_react_buttons_1.ButtonComponent, { cssClass: 'e-small e-round', iconCss: 'e-icons e-add-icon', isPrimary: true })),
                                React.createElement("div", { className: "col-xs-12 col-sm-12 col-lg-6 col-md-6" },
                                    React.createElement(ej2_react_buttons_1.ButtonComponent, { cssClass: 'e-flat e-primary', ref: function (scope) { _this.btnobj = scope; }, iconCss: 'e-icons e-play-icon', isToggle: true, onClick: this.btnClick.bind(this) }, "Play"))),
                            React.createElement("div", { className: "col-xs-6 col-sm-6 col-lg-6 col-md-6" },
                                React.createElement("div", { className: "col-xs-12 col-sm-12 col-lg-6 col-md-6" },
                                    React.createElement(ej2_react_buttons_1.ButtonComponent, { cssClass: 'e-flat e-primary', iconCss: 'e-icons e-open-icon', iconPosition: 'Right' }, "Open")),
                                React.createElement("div", { className: "col-xs-12 col-sm-12 col-lg-6 col-md-6" },
            ...
            React.createElement("div", { id: "description" },
                ...
                React.createElement("p", null,
                    ...
                    React.createElement("a", { target: "_blank", href: "http://ej2.syncfusion.com/react/documentation/button/api-buttonComponent.html#istoggle-boolean" },
                ...
                React.createElement("p", null,
                    ...
                    React.createElement("a", { target: '_blank', href: 'http://ej2.syncfusion.com/react/documentation/button/getting-started.html' }, "documentation section"),
                    "."))));
    };
    return Default;
