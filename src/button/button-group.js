        ...
        return (React.createElement("div", { className: 'control-pane' },
                    ...
                    React.createElement("div", { id: "button-group-control" },
                        React.createElement("div", { className: "row" },
                            ...
                            React.createElement("div", { id: "bgicon", className: "e-btn-group" },
                                React.createElement(ej2_react_buttons_1.ButtonComponent, { iconCss: 'e-icons e-btngrp-watch' }),
                                React.createElement(ej2_react_buttons_1.ButtonComponent, { iconCss: 'e-icons e-btngrp-star' }),
                                React.createElement(ej2_react_buttons_1.ButtonComponent, { iconCss: 'e-icons e-btngrp-download' }))),
                        React.createElement("div", { className: "row" },
                        ...
                        React.createElement("div", { className: "row" },
                            ...
                            React.createElement("div", { id: "iconandtext", className: "e-btn-group" },
                                ...
                                React.createElement("label", { className: "e-btn", htmlFor: "bold" },
                                    React.createElement("span", { className: "e-btn-icon e-icons e-btngrp-bold e-icon-left" }),
                                    "Bold"),
                                ...
                                React.createElement("label", { className: "e-btn", htmlFor: "italic" },
                                    React.createElement("span", { className: "e-btn-icon e-icons e-btngrp-italic e-icon-left" }),
                                    "Italic"),
                                ...
                                React.createElement("label", { className: "e-btn", htmlFor: "underline" },
                                    React.createElement("span", { className: "e-btn-icon e-icons e-btngrp-underline e-icon-left" }),
                                    "Underline")))))),
            ...
            React.createElement("div", { id: "description" },
                ...
                React.createElement("p", null,
                    ...
                    React.createElement("a", { target: "_blank", href: "http://ej2.syncfusion.com/documentation/button-group/getting-started.html" }, "documentation section"),
                    "."))));
    };
    return ButtonGroup;
