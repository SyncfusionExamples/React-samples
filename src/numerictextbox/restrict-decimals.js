        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { id: "description" },
                React.createElement("p", null,
                    ...
                    React.createElement("a", { href: "http://ej2.syncfusion.com/react/documentation/numerictextbox/api-numericTextBoxComponent.html#decimals-number", target: "_blank" }, " decimals"),
                    " property. To restrict the number of decimal values on typing, use the ",
                    React.createElement("a", { href: "http://ej2.syncfusion.com/react/documentation/numerictextbox/api-numericTextBoxComponent.html#decimals-number", target: "_blank" }, " decimals"),
                    " and ",
                    React.createElement("a", { href: "http://ej2.syncfusion.com/react/documentation/numerictextbox/api-numericTextBoxComponent.html#validatedecimalontype-boolean", target: "_blank" }, "validateDecimalOnType"),
                    " properties."),
                React.createElement("p", null,
                    "More information on the restrict decimals configuration can be found in the ",
                    React.createElement("a", { href: "http://ej2.syncfusion.com/react/documentation/numerictextbox/getting-started.html#precision-of-numbers", target: "_blank" }, "documentation section"),
                    "."))));
    };
    return Restrict;
