    ...
    AnnotationsSample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_circulargauge_1.CircularGaugeComponent, { load: this.load.bind(this), id: 'annotation-container', ref: function (gauge) { return _this.gauge = gauge; }, loaded: this.onChartLoad.bind(this), resized: this.onResized.bind(this), centerY: '45%', titleStyle: { color: 'black', size: '16px' } },
                    ...
                    React.createElement(ej2_react_circulargauge_1.AxesDirective, null,
                        React.createElement(ej2_react_circulargauge_1.AxisDirective, { startAngle: 0, endAngle: 0, radius: ej2_base_1.Browser.isDevice ? '90%' : '70%', minimum: 0, maximum: 12, majorTicks: {
                            ...
                            React.createElement(ej2_react_circulargauge_1.AnnotationsDirective, null,
                                ...
                                React.createElement(ej2_react_circulargauge_1.AnnotationDirective, { content: '<div id="hr" style="background-color:rgba(29,29,29,0.6); color:white;font-size:12px;">11:11 AM</div>', angle: 90, radius: '40%', zIndex: '1' }),
                            ...
                            React.createElement(ej2_react_circulargauge_1.PointersDirective, null,
                                React.createElement(ej2_react_circulargauge_1.PointerDirective, { pointerWidth: 5, radius: '40%', color: 'rgba(29,29,29,0.8)', border: { width: 0, color: '#679EEF' }, cap: { radius: 0, border: { width: 0, color: 'red' } }, needleTail: { length: '0%' }, animation: { enable: false } }),
                                React.createElement(ej2_react_circulargauge_1.PointerDirective, { radius: '60%', pointerWidth: 5, color: 'rgba(29,29,29,0.8)', border: { width: 0, color: '#2856B6' }, cap: { color: 'rgba(29,29,29,0.8)', radius: 0, border: { width: 0, color: 'red' } }, needleTail: { length: '0%' }, animation: { enable: false } }),
                                React.createElement(ej2_react_circulargauge_1.PointerDirective, { radius: '70%', pointerWidth: 1, color: 'rgba(29,29,29,0.8)', cap: { color: 'white', radius: 4, border: { width: 2, color: 'rgba(29,29,29,0.8)' } }, border: { width: 2, color: 'rgba(29,29,29,0.8)' }, needleTail: { color: 'rgba(29,29,29,0.8)', length: '20%', border: { width: 2, color: 'rgba(29,29,29,0.8)' } }, animation: { enable: false, duration: 500 } })),
                            React.createElement(ej2_react_circulargauge_1.RangesDirective, null,
                                React.createElement(ej2_react_circulargauge_1.RangeDirective, { start: 0, end: 3, color: 'rgba(29,29,29,0.6)' }),
                                React.createElement(ej2_react_circulargauge_1.RangeDirective, { start: 3, end: 12, color: 'rgba(226, 226, 226, 0.6)' })))))),
