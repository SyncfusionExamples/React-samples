        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section accordion-control-section' },
                React.createElement("div", { className: 'control Accordion-sample', style: { margin: '25px 0' } },
                    React.createElement(ej2_react_navigations_1.AccordionComponent, { enableRtl: true },
            ...
            React.createElement("div", { id: 'description' },
                React.createElement("p", null, "The RTL sample illustrates the direction of the Accordion from right to left."),
                React.createElement("p", null,
