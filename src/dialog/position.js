    ...
    Positioning.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { id: 'target', className: 'col-lg-12 control-section dialog-position' },
                ...
                React.createElement(ej2_react_popups_1.DialogComponent, { id: 'defaultDialog', header: 'Choose a Dialog Position', visible: this.state.hideDialog, showCloseIcon: true, position: this.position, footerTemplate: this.footerTemplate, width: '452px', ref: function (defaultDialog) { return _this.defaultDialogInstance = defaultDialog; }, target: '#target', open: this.dialogOpen.bind(this), close: this.dialogClose.bind(this), closeOnEscape: false },
                ...
                React.createElement("div", { id: "action-description" },
                    React.createElement("p", null, "This sample demonstrates how to position the dialog component. Select the appropriate radio button to position where the dialog is displayed. The current position of the dialog is at the bottom.  Enable the \"open dialog\" button to reopen the dialog if it is closed.")),
                React.createElement("div", { id: "description" },
                    React.createElement("p", null,
                        "By default, the dialog is displayed in the center of the target container. Use the ",
                        React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/dialog/api-dialogComponent.html#position" }, "position"),
                    ...
                    React.createElement("p", null,
                        ...
                        React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/dialog/getting-started.html#positioning" }, "documentation section"),
                        ".")))));
    };
    return Positioning;
