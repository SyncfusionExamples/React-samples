...
var Template = (function (_super) {
    ...
    Template.prototype.header = function (data) {
    ...
    Template.prototype.footerTemplate = function (data) {
        return (React.createElement("div", null,
    ...
    Template.prototype.content = function (data) {
    ...
    Template.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This sample demonstrates the template functionalities of the dialog component. The dialog's header and footer is configured with HTML template. The typed content will be replaced every time when clicking the \"send\" button.")),
            React.createElement("div", { id: "description" },
                ...
                React.createElement("p", null,
                    ...
                    React.createElement("a", { target: "_blank", href: "http://ej2.syncfusion.com/15.4.23/react/documentation/dialog/template.html" }, "documentation section"),
                    "."))));
    };
    return Template;
