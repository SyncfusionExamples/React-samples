    ...
    AjaxContent.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This sample demonstrates that the content of dialog can be loaded from external HTML file. Click \"more details\" on dialog to load the content dynamically from external HTML file. Click \u201Copen\u201D to show the dialog again, if it is closed.")),
