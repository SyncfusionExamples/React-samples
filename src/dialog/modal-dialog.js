    ...
    Modal.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This sample demonstrates that the modal behavior of dialog component. Choose \"close on overlay\" option from property panel to decide whether the dialog can be closed when clicking overlay. Click \u201Copen\u201D to show the dialog again, if it is in closed state.")),
            React.createElement("div", { id: "description" },
                ...
                React.createElement("p", null,
                    ...
                    React.createElement("a", { target: "_blank", href: "http://ej2.syncfusion.com/react/documentation/dialog/getting-started.html#modal-dialog" }, "documentation section"),
                    "."))));
    };
    return Modal;
