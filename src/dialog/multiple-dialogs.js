    ...
    MultipleDialogs.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { id: 'target', className: 'col-lg-12 control-section dialog-target' },
                ...
                React.createElement(ej2_react_popups_1.DialogComponent, { id: 'defaultDlg', header: 'First Dialog', visible: this.state.hideDialog1, showCloseIcon: true, animationSettings: this.animationSettings, width: '330px', ref: function (defaultDialog) { return _this.defaultDialogInstance = defaultDialog; }, target: '#target', buttons: this.dlgButton, open: this.dialogOpen.bind(this), close: this.dialogClose.bind(this) },
                ...
                React.createElement("div", { id: "description" },
                    React.createElement("p", null,
                        ...
                        React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/dialog/api-dialogComponent.html#zindex" }, " zIndex "),
                        " property.")))));
    };
