        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null,
                    ...
                    " if there is no selected date. Click the desired date from the Calendar and the selected date will be displayed in the below label.")),
            React.createElement("div", { id: 'description' },
                ...
                React.createElement("p", null,
                    ...
                    React.createElement("a", { target: '_blank', href: 'https://ej2.syncfusion.com/react/documentation/calendar/getting-started.html' }, "documentation"),
                    " section."))));
    };
    return Default;
