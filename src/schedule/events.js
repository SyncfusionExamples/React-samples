    ...
    Events.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'schedule-control-section' },
            ...
            React.createElement("div", { id: 'action-description' },
                React.createElement("p", null, "This demo illustrates the client-side events that triggers on respective Schedule actions and the same is being displayed on the event trace panel.")),
            React.createElement("div", { id: 'description' },
                React.createElement("p", null, "In this demo, the client-side events that triggers based on the action taking place in Schedule has been demonstrated. The user can make use of these events, if at some point they need to perform some custom actions or any needed additional customizations on the available Schedule features."))));
    };
    return Events;
