...
var TimelineGrouping = (function (_super) {
    ...
    function TimelineGrouping() {
        ...
        _this.data = ej2_base_1.extend([], datasource_1.resourceData.concat(datasource_1.timelineResourceData), null, true);
        _this.projectData = [
                ...
                React.createElement("div", { className: 'control-wrapper' },
                    React.createElement(ej2_react_schedule_1.ScheduleComponent, { cssClass: 'timeline-resource-grouping', width: '100%', height: '650px', selectedDate: new Date(2018, 3, 4), currentView: 'TimelineWeek', eventSettings: {
                        ...
                        React.createElement(ej2_react_schedule_1.ResourcesDirective, null,
                            ...
                            React.createElement(ej2_react_schedule_1.ResourceDirective, { field: 'TaskId', title: 'Category', name: 'Categories', allowMultiple: true, dataSource: this.categoryData, textField: 'text', idField: 'id', colorField: 'color' })),
