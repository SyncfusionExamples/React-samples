...
var TimelineResource = (function (_super) {
    ...
    function TimelineResource() {
        ...
        _this.data = ej2_base_1.extend([], datasource_1.roomData, null, true);
        ...
        return (React.createElement("div", { className: 'schedule-control-section' },
            ...
            React.createElement("div", { id: "description" },
                React.createElement("p", null,
                    ...
                    " property. Also, the lunch time blocking is done by applying styles on those cells through the",
                    React.createElement("code", null, "renderCell"),
                    " event. The event editor and popup is prevented to open on those blocked time slots as well as on the past bookings by making use of the",
