    ...
    Group.prototype.render = function () {
        return (React.createElement("div", { className: 'schedule-control-section' },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This demo illustrates the timings of different flight services on a specific route say between Barcelona and Los Angeles, on a daily basis. Here, the Schedule is grouped based on the 3 Airline services.")),
            React.createElement("div", { id: "description" },
                ...
                React.createElement("p", null,
                    "Note: If the",
                    React.createElement("code", null, "group"),
                    " property is not defined, then the default schedule will be rendered with no grouping on layout, but the appointments of all the resources will be displayed on a single schedule."))));
    };
    return Group;
