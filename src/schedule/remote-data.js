    ...
    RemoteData.prototype.render = function () {
        return (React.createElement("div", { className: 'schedule-control-section' },
            ...
            React.createElement("div", { id: 'action-description' },
                React.createElement("p", null, "This demo showcases the way of binding remote services to Schedule component. Here, the DataManager is used to bind the remote data with Schedule.")),
            React.createElement("div", { id: 'description' },
                React.createElement("p", null,
                    ...
                    "."),
                React.createElement("p", null, "The DataManager here acts as an interface between the service endpoint and the Schedule, and will require the below minimal information to interact with the service endpoint properly."),
