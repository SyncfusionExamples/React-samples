...
var EditorTemplate = (function (_super) {
    ...
    function EditorTemplate() {
        ...
        _this.data = ej2_base_1.extend([], datasource_1.doctorsEventData, null, true);
        return _this;
    }
    EditorTemplate.prototype.onPopupOpen = function (args) {
        if (args.type === 'Editor') {
    ...
    EditorTemplate.prototype.editorTemplate = function (props) {
        return (React.createElement("table", { className: "custom-event-editor", style: { width: '100%', cellpadding: '5' } },
            React.createElement("tbody", null,
                ...
                React.createElement("tr", null,
                    ...
                    React.createElement("td", { style: { colspan: '4' } },
                        React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { id: "EventType", placeholder: 'Choose status', className: "e-field", style: { width: '100%' }, dataSource: ['New', 'Requested', 'Confirmed'] }))),
                React.createElement("tr", null,
                    React.createElement("td", { className: "e-textlabel" }, "From"),
                    React.createElement("td", { style: { colspan: '4' } },
                        React.createElement(ej2_react_calendars_1.DateTimePickerComponent, { id: "StartTime", className: "e-field" }))),
                React.createElement("tr", null,
                    React.createElement("td", { className: "e-textlabel" }, "To"),
                    React.createElement("td", { style: { colspan: '4' } },
                        React.createElement(ej2_react_calendars_1.DateTimePickerComponent, { id: "EndTime", className: "e-field" }))),
                React.createElement("tr", null,
        ...
        return (React.createElement("div", { className: 'schedule-control-section' },
            ...
            React.createElement("div", { id: 'description' },
                ...
                React.createElement("p", null,
                    ...
                    " event that triggers before every appointment getting rendered on the Schedule user interface, the colors for the appointments are set based on its status which is retrieved from the appointment data."),
                React.createElement("p", null,
                    "The additional restriction has been added to the Schedule cells such that if a cell already contains an appointment \u2013 then it should be prevented to book with multiple appointments on the same time for which the ",
