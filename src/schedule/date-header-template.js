        ...
        return (React.createElement("div", { className: 'schedule-control-section' },
            React.createElement("div", { className: 'control-section' },
                React.createElement("div", { className: 'control-wrapper' },
                    React.createElement(ej2_react_schedule_1.ScheduleComponent, { width: '100%', height: '650px', cssClass: 'schedule-date-header-template', ref: function (t) { return _this.scheduleObj = t; }, renderCell: this.onRenderCell.bind(this), eventRendered: this.onEventRendered.bind(this), selectedDate: new Date(2018, 1, 15), eventSettings: { dataSource: this.data }, dateHeaderTemplate: this.dateHeaderTemplate.bind(this) },
