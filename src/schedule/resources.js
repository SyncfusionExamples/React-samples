    ...
    Resources.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'schedule-control-section' },
            ...
            React.createElement("div", { id: "description" },
                React.createElement("p", null,
                    "In this demo, Schedule initially displays the fare of the airline service which offers lowest price on each day by comparing between the 3 available airlines. Here, the 3 airline services acts as the Schedule resources. Appointment collection has been dynamically generated for a month (for all the 3 resources) within the",
                    ...
                    " method. Since each day of the Schedule needs to display only a single appointment showing the fare value, therefore it\u2019s been queried to take only the first 30 values from the sorted list and assigned it to the Schedule",
                    React.createElement("code", null, "dataSource"),
                    ". Here, the filtering process needs to be carried out during the",
                    React.createElement("code", null, "databinding"),
                    " event and therefore, the dataSource of Schedule is assigned within this event."),
                React.createElement("p", null,
                    "Schedule has been rendered in a readonly mode and therefore no editing actions are allowed here. To customize the look of the appointments that displays the fare value,",
