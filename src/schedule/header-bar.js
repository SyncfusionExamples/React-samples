    ...
    HeaderBar.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'schedule-control-section' },
            ...
            React.createElement("div", { id: 'action-description' },
                React.createElement("p", null, "This demo shows the way of adding custom items into the Schedule header bar. Here, an employee image is added to the header bar, clicking on which will open the popup showing that person's short profile information.")),
            React.createElement("div", { id: 'description' },
                React.createElement("p", null,
                    "In this demo, a popup has been designed separately with a person\u2019s profile info and kept in a hidden state initially. A custom item has been added to the Schedule header bar within the ",
                    ...
                    " which triggers at the time of header bar items rendering on the Schedule."),
                React.createElement("p", null,
                    ...
                    " which triggers after the items are rendered on the Schedule. The appropriate action of showing or hiding the popup on clicking the custom item has been done within it."),
                React.createElement("p", null,
