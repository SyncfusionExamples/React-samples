        ...
        return (React.createElement("div", { className: 'schedule-control-section' },
            React.createElement("div", { className: 'col-lg-9 control-section' },
                React.createElement("div", { className: 'control-wrapper' },
                    React.createElement(ej2_react_schedule_1.ScheduleComponent, { height: '550px', ref: function (schedule) { return _this.scheduleObj = schedule; }, selectedDate: new Date(2018, 1, 15), eventSettings: { dataSource: this.data }, currentView: 'TimelineWeek', timeScale: { enable: true, interval: 60, slotCount: 6 } },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This demo depicts how to customize the grid lines of schedule with different duration, count and also, how to apply template customizations on it.")),
            React.createElement("div", { id: "description" },
                React.createElement("p", null,
                    "In this demo, schedule has been allowed to display different number of grid lines per hour assigned with different duration to each cell, by making use of the",
