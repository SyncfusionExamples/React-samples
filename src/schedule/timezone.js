...
var TimeZone = (function (_super) {
    ...
    function TimeZone() {
        ...
        _this.fifaEvents = ej2_base_1.extend([], datasource_1.fifaEventsData, null, true);
    ...
    TimeZone.prototype.onCreate = function () {
        for (var _i = 0, _a = this.fifaEvents; _i < _a.length; _i++) {
            ...
            event_1.StartTime = this.timezone.removeLocalOffset(event_1.StartTime);
            event_1.EndTime = this.timezone.removeLocalOffset(event_1.EndTime);
        }
    };
    ...
    TimeZone.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'schedule-control-section' },
            ...
            React.createElement("div", { id: 'action-description' },
                React.createElement("p", null, "This demo visualizes the 2018 FIFA football match schedule which is depicted as events here. The timings of each event are associated with the timezone of the match location where it will be held. When the Schedule time zone changes, the events in it displays according to the selected timezone's offset time difference.")),
            React.createElement("div", { id: 'description' },
                React.createElement("p", null,
                    "In this demo, the ",
                    React.createElement("code", null, "timezone"),
                    " of Schedule is set to UTC and each events on it holds different ",
                    React.createElement("code", null, "startTimezone"),
                    " and ",
                    React.createElement("code", null, "endTimezone"),
                    " values, therefore the event timings will be converted based on timezone assigned to Schedule and will be displayed appropriately in UTC timings."),
                React.createElement("p", null,
                    "When the user selects different timezone value listed out in a dropdown on properties panel, Schedule will display the events accordingly to the selected timezone value as the selected timezone will be assigned to Schedule ",
                    React.createElement("code", null, "timezone"),
                    " property."))));
    };
    return TimeZone;
