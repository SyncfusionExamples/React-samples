...
var GroupCustomWorkDays = (function (_super) {
    ...
    function GroupCustomWorkDays() {
        ...
        _this.data = ej2_base_2.extend([], datasource_1.doctorData, null, true);
        _this.resourceData = [
    ...
    GroupCustomWorkDays.prototype.onResizeStart = function (args) {
        args.cancel = true;
    };
    GroupCustomWorkDays.prototype.onDragStart = function (args) {
        args.cancel = true;
    };
            ...
            React.createElement("div", { className: 'col-lg-12 control-section' },
                React.createElement("div", { className: 'control-wrapper' },
                    React.createElement(ej2_react_schedule_1.ScheduleComponent, { ref: function (schedule) { return _this.scheduleObj = schedule; }, cssClass: 'custom-work-days', width: '100%', height: '650px', selectedDate: new Date(2018, 3, 1), currentView: 'WorkWeek', resourceHeaderTemplate: this.resourceHeaderTemplate.bind(this), eventSettings: {
                        ...
                        }, actionBegin: this.onActionBegin.bind(this), popupOpen: this.onPopupOpen.bind(this), renderCell: this.onRenderCell.bind(this), resizeStart: this.onResizeStart.bind(this), group: { resources: ['Doctors'] }, dragStart: this.onDragStart.bind(this) },
