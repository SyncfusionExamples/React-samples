...
var AddRemoveResources = (function (_super) {
    ...
    AddRemoveResources.prototype.generateCalendarData = function () {
        return datasource_1.personalData.concat(datasource_1.companyData, datasource_1.birthdayData, datasource_1.holidayData);
    };
    ...
    AddRemoveResources.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'schedule-control-section' },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This demo illustrates how to dynamically add or remove resources to and from the Schedule layout.")),
            React.createElement("div", { id: "description" },
                React.createElement("p", null,
                    "In this demo, Schedule is initially displayed with single resource with its related set of appointments. When the additional checkboxes given are checked and unchecked, the respective resources gets added up or removed from the schedule layout. To add new resources dynamically,",
