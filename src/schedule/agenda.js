        ...
        return (React.createElement("div", { className: 'schedule-control-section' },
            React.createElement("div", { className: 'col-lg-9 control-section' },
                React.createElement("div", { className: 'control-wrapper' },
                    React.createElement(ej2_react_schedule_1.ScheduleComponent, { width: '100%', height: '650px', ref: function (schedule) { return _this.scheduleObj = schedule; }, currentView: 'Agenda', selectedDate: new Date(2018, 1, 15), eventSettings: { dataSource: datasource_1.generateObject() } },
            ...
            React.createElement("div", { id: 'description' },
                React.createElement("p", null,
                    ...
                    " property of the Schedule. The initial data loading for 7 days count is due to the default value assigned to the ",
                    React.createElement("code", null, "agendaDaysCount"),
                    " property which can be customized as per the user needs."),
                React.createElement("p", null,
                    "When the ",
                    React.createElement("code", null, "allowVirtualScrolling"),
                    " property is set to true, the user is allowed to scroll through all the events simply by scrolling up and down upto the last event available in Schedule."),
                React.createElement("p", null,
