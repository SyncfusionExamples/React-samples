        ...
        return (React.createElement("div", { className: 'schedule-control-section' },
            React.createElement("div", { className: 'col-lg-12 control-section' },
                React.createElement("div", { className: 'control-wrapper schedule-wrapper' },
                    React.createElement(ej2_react_schedule_1.ScheduleComponent, { width: '100%', height: '650px', selectedDate: new Date(2018, 5, 20), eventSettings: { dataSource: this.data } },
            ...
            React.createElement("div", { id: 'description' },
                ...
                React.createElement("p", null,
                    "To work with Month Agenda view on Schedule \u2013 it is necessary to inject the MonthAgenda module using ",
