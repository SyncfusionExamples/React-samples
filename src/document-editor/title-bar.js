...
var TitleBar = (function () {
    function TitleBar(element, docEditor, isShareNeeded) {
        ...
        this.initializeTitleBar = function (isShareNeeded) {
            ...
            // tslint:disable-next-line:max-line-length
            _this.documentTitleContentEditor = ej2_base_1.createElement('div', { id: 'documenteditor_title_contentEditor', className: 'single-line', styles: 'border: 1px solid #2B3481;' });
