...
export const dropdown-listRoutes = (
    <div>
...
export const dropdown-listCategory = {"default":{"name":"Default Functionalities","category":"DropDownList"},"grouping-icon":{"name":"Grouping and Icons","category":"DropDownList"},"data-binding":{"name":"Data Binding","category":"DropDownList"},"filtering":{"name":"Filtering","category":"DropDownList"},"template":{"name":"Templates","category":"DropDownList"},"cascading":{"name":"Cascading","category":"DropDownList"},"inline":{"name":"Inline","category":"DropDownList"},"diacritics-filtering":{"name":"Diacritics Filtering","category":"DropDownList"},"defaultSample":"drop-down-list/default"}