...
require("./sidebarapi-component.css");
    ...
    API.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "control-section" },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This sample demonstrates the Sidebar component with its features. Click the button to view the Sidebar sample in a new tab.")),
