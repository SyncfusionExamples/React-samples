    ...
    ChunkUpload.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This sample demonstrates the chunk upload functionalities of the Uploader component. Browse the files which you want to upload to the server. The selected files are submitted to server on upload button click based on the selected chunk size. Also, You can pause the uploading file and resuming it. Once the upload got failed, it will retry automatically. Even it fails to upload in auto retry, retry button will be enabled to retry the upload later."),
                React.createElement("p", null, "Also, provided option to change the chunk size values from the property panel")),
            React.createElement("div", { id: "description" },
                React.createElement("p", null,
                    ...
                    React.createElement("a", { href: "https://ej2.syncfusion.com/react/documentation/uploader/api-asyncSettingsModel.html#chunksize", target: "_blank" }, "\u00A0chunkSize"),
                ...
                React.createElement("p", null,
                    ...
                    React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/uploader/chunk-upload.html" }, "documentation section"),
                    "."))));
    };
    return ChunkUpload;
