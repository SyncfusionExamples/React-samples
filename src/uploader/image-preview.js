    ...
    Preview.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane', ref: this.dropContainerRef },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This sample demonstrates how to add an image preview of the uploaded files. Only image files (PNG, JPG) are allowed to upload in this demo."),
                React.createElement("p", null, "This sample demonstrates the how to preview the uploaded images. Click on browse link to choose image files or drag and drop the selected image files and display it with file name, type and size.")),
