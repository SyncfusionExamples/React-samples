    ...
    Preloadfiles.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane', ref: this.dropContainerRef },
                    ...
                    React.createElement("div", { className: 'validation_wrapper' },
                        React.createElement(ej2_react_inputs_1.UploaderComponent, { id: 'validation', type: 'file', ref: function (scope) { _this.uploadObj = scope; }, asyncSettings: this.asyncSettings, removing: this.onRemoveFile.bind(this) },
                            React.createElement(ej2_react_inputs_1.FilesDirective, null,
                                ...
                                React.createElement(ej2_react_inputs_1.UploadedFilesDirective, { name: "TypeScript succintly", size: 12000, type: ".pdf" }),
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This sample demonstrates how to pre-load the files of the Uploader. The already uploaded files are configured in file list to view and remove them.")),
            React.createElement("div", { id: "description" },
                ...
                React.createElement("p", null,
                    ...
                    React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/uploader/asynchronous.html#preload-files" }, "documentation section"),
                    "."),
