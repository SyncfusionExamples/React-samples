    ...
    Customdroparea.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, " This sample demonstrates how to configure custom drop area of the Uploader. You can drop the files into specified custom drop area location to upload.  ")),
            React.createElement("div", { id: "description" },
                React.createElement("p", null,
                    "The Uploader component allows to set any external element as drop area using the \u00A0",
                    React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/documentation/uploader/api-uploader.html?lang=typescript#droparea" }, "dropArea"),
                    " property."),
                React.createElement("p", null,
                    "More information on the drag-and-drop can be found on this",
                    React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/uploader/file-source.html#drag-and-drop" }, " documentation section"),
                    "."))));
    };
