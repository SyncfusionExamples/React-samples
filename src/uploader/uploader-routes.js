...
exports.uploaderCategory = { "default": { "name": "Default Functionalities", "category": "Uploader" }, "chunk-upload": { "name": "Chunk Upload", "category": "Uploader" }, "custom-file-list": { "name": "Template", "category": "Uploader" }, "preload-files": { "name": "Preload files", "category": "Uploader" }, "file-validation": { "name": "File Validation", "category": "Uploader" }, "image-preview": { "name": "Image Preview", "category": "Uploader" }, "file-upload-with-forms": { "name": "Form Support", "category": "Uploader" }, "custom-drop-area": { "name": "Custom Drop Area", "category": "Uploader" }, "defaultSample": "uploader/default" };
