...
var Format = (function (_super) {
    ...
    Format.prototype.onScroll = function () {
        if (!ej2_base_1.isNullOrUndefined(document.getElementById('slider01')) &&
            !ej2_base_1.isNullOrUndefined(document.getElementById('slider01').ej2_instances[0]) && !ej2_base_1.isNullOrUndefined(document.getElementById('slider02')) &&
            !ej2_base_1.isNullOrUndefined(document.getElementById('slider02').ej2_instances[0]) && !ej2_base_1.isNullOrUndefined(document.getElementById('slider03')) &&
            !ej2_base_1.isNullOrUndefined(document.getElementById('slider03').ej2_instances[0])) {
            var element01 = document.getElementById('slider01');
            var element02 = document.getElementById('slider02');
            var element03 = document.getElementById('slider03');
            for (var _i = 0, _a = [element01, element02, element03]; _i < _a.length; _i++) {
                var slider = _a[_i];
