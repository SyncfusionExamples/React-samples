...
var TooltipCustomization = (function (_super) {
    ...
    TooltipCustomization.prototype.onCreated01 = function (args) {
        var element01 = document.getElementById('slider01');
    ...
    TooltipCustomization.prototype.onScroll = function () {
        if (!ej2_base_1.isNullOrUndefined(document.getElementById('slider01')) &&
            !ej2_base_1.isNullOrUndefined(document.getElementById('slider01').ej2_instances[0]) && !ej2_base_1.isNullOrUndefined(document.getElementById('out')) &&
            !ej2_base_1.isNullOrUndefined(document.getElementById('out').ej2_instances[0])) {
            var element01 = document.getElementById('slider01');
            var element02 = document.getElementById('out');
            ...
            React.createElement("div", { className: 'col-lg-12-control-section' },
                React.createElement("div", { className: "content-wrapper" },
                    React.createElement("div", { className: "sliderwrap" },
                        ...
                        React.createElement(ej2_react_inputs_1.SliderComponent, { id: "slider01", value: this.value, min: this.min, max: this.max, step: 3600000 / 6, ticks: this.ticks, type: "Range", tooltip: this.tooltip, tooltipChange: this.tooltipChangeHandler.bind(this), ref: function (slider) { _this.timeObj = slider; }, created: this.onCreated01.bind(this), renderingTicks: this.onRenderingTicks.bind(this) })),
                    React.createElement("div", { className: "sliderwrap" },
                        React.createElement("label", { className: "labeltext userselect" },
