...
var Tooltip = (function (_super) {
    ...
    Tooltip.prototype.onScroll = function () {
        if (!ej2_base_1.isNullOrUndefined(document.getElementById('slider01')) &&
            !ej2_base_1.isNullOrUndefined(document.getElementById('slider01').ej2_instances[0]) &&
            !ej2_base_1.isNullOrUndefined(document.getElementById('slider02')) &&
            !ej2_base_1.isNullOrUndefined(document.getElementById('slider02').ej2_instances[0])) {
