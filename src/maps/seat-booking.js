            ...
            React.createElement("div", { className: 'control-section row' },
                React.createElement("div", { className: 'col-md-8' },
                    React.createElement("div", { style: { width: 200, margin: 'auto', paddingBottom: 20 } },
                        React.createElement("img", { src: "src/maps/images/bus-icon.png", style: { width: 25, height: 25, float: 'left' } }),
                    ...
                    React.createElement("div", { style: { border: '3px solid darkgray', width: 200, display: 'block', margin: 'auto' } },
                        React.createElement("img", { src: "src/maps/images/wheel.png", style: { width: 30, height: 30, marginLeft: '18%', marginTop: 10 } }),
                        React.createElement(ej2_react_maps_1.MapsComponent, { id: "maps", loaded: this.onMapsLoad.bind(this), load: this.load, ref: function (m) { return _this.mapInstance = m; }, zoomSettings: {
                            ...
                            React.createElement(ej2_react_maps_1.LayersDirective, null,
                                React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: new ej2_maps_1.MapAjax(location.origin + location.pathname + 'src/maps/map-data/seat-selection.json'), geometryType: 'Normal', shapeSettings: {
                                        colorValuePath: 'fill'
                                    }, selectionSettings: {
                                        enable: true,
                                        opacity: 1,
