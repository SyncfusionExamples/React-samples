...
var DrilldownMaps = (function (_super) {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section row' },
                ...
                React.createElement("div", { className: 'col-md-12' },
                    React.createElement(ej2_react_maps_1.MapsComponent, { id: "maps", ref: function (m) { return _this.mapInstance = m; }, loaded: this.onMapsLoad.bind(this), load: this.load, shapeSelected: this.shapeSelected.bind(this), zoomSettings: {
                            enable: false
                        } },
                        ...
                        React.createElement(ej2_react_maps_1.LayersDirective, null,
                            React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: new ej2_maps_1.MapAjax(location.origin + location.pathname + 'src/maps/map-data/world-map.json'), layerType: 'Geometry', shapePropertyPath: 'continent', shapeDataPath: 'continent', dataSource: new ej2_maps_1.MapAjax(location.origin + location.pathname + 'src/maps/map-data/default-datasource.json'), shapeSettings: {
                            ...
                            React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: new ej2_maps_1.MapAjax(location.origin + location.pathname + 'src/maps/map-data/africa.json'), layerType: 'Geometry', shapeSettings: {
                                    fill: '#80306A'
                                }, highlightSettings: {
                                    enable: true,
                                    fill: '#80306A'
                            ...
                            React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: new ej2_maps_1.MapAjax(location.origin + location.pathname + 'src/maps/map-data/europe.json'), layerType: 'Geometry', shapeSettings: {
                                    fill: '#622D6C'
                                }, highlightSettings: {
                                    enable: true,
                                    fill: '#622D6C'
                            ...
                            React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: new ej2_maps_1.MapAjax(location.origin + location.pathname + 'src/maps/map-data/asia.json'), layerType: 'Geometry', shapeSettings: {
                                    fill: '#462A6D'
                                }, highlightSettings: {
                                    enable: true,
                                    fill: '#462A6D'
                            ...
                            React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: new ej2_maps_1.MapAjax(location.origin + location.pathname + 'src/maps/map-data/north-america.json'), layerType: 'Geometry', shapeSettings: {
                                    fill: '#C13664'
                                }, highlightSettings: {
                                    enable: true,
                                    fill: '#C13664'
                            ...
                            React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: new ej2_maps_1.MapAjax(location.origin + location.pathname + 'src/maps/map-data/south-america.json'), layerType: 'Geometry', shapeSettings: {
                                    fill: '#9C3367'
                                }, highlightSettings: {
                                    enable: true,
                                    fill: '#9C3367'
                            ...
                            React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: new ej2_maps_1.MapAjax(location.origin + location.pathname + 'src/maps/map-data/oceania.json'), layerType: 'Geometry', shapeSettings: {
                                    fill: '#2A2870'
                                }, highlightSettings: {
                                    enable: true,
                                    fill: '#2A2870'
    ...
    DrilldownMaps.prototype.onMapsLoad = function (args) {
