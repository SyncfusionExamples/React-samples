    ...
    AnnotationMaps.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section row' },
                React.createElement(ej2_react_maps_1.MapsComponent, { id: "maps", loaded: this.onMapsLoad.bind(this), load: this.load, ref: function (m) { return _this.mapInstance = m; }, zoomSettings: {
                    ...
                    React.createElement(ej2_react_maps_1.LayersDirective, null,
                        React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: new ej2_maps_1.MapAjax(location.origin + location.pathname + 'src/maps/map-data/africa-continent.json'), shapePropertyPath: 'name', shapeDataPath: 'name', shapeSettings: {
                                fill: 'url(#grad1)'
                            } },
            ...
            React.createElement("div", { id: "compass-maps", style: { display: 'none' } },
                React.createElement("img", { src: "src/maps/images/compass.svg", height: "75px", width: "75px" })),
