                    ...
                    React.createElement(ej2_react_maps_1.LayersDirective, null,
                        React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: new ej2_maps_1.MapAjax(location.origin + location.pathname + 'src/maps/map-data/world-map.json'), shapePropertyPath: 'continent', shapeDataPath: 'continent', dataSource: new ej2_maps_1.MapAjax(location.origin + location.pathname + 'src/maps/map-data/default-datasource.json'), shapeSettings: {
                            ...
                            React.createElement(ej2_react_maps_1.MarkersDirective, null,
                                ...
                                React.createElement(ej2_react_maps_1.MarkerDirective, { visible: true, shape: 'Image', imageUrl: 'src/maps/images/ballon.png', height: 20, width: 20, offset: {
                                        y: -10,
                                        x: 0
