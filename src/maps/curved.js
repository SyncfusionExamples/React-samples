...
var map_location_1 = require("./map-data/map-location");
var navigation_data_1 = require("./map-data/navigation-data");
                ...
                React.createElement("div", { className: 'col-md-12' },
                    React.createElement(ej2_react_maps_1.MapsComponent, { id: "maps", loaded: this.onMapsLoad.bind(this), load: this.load, ref: function (m) { return _this.mapInstance = m; }, centerPosition: {
                        ...
                        React.createElement(ej2_react_maps_1.LayersDirective, null,
                            React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: new ej2_maps_1.MapAjax(location.origin + location.pathname + 'src/maps/map-data/world-map.json'), shapeDataPath: 'name', shapePropertyPath: 'name', dataSource: [
                                    {
                                        name: 'India'
                                    },
                                    {
                                ...
                                }, navigationLineSettings: navigation_data_1.data },
                                React.createElement(ej2_react_maps_1.MarkersDirective, null,
                                    React.createElement(ej2_react_maps_1.MarkerDirective, { visible: true, shape: 'Circle', fill: 'white', width: 4, animationDuration: 0, border: { color: 'black', width: 1 }, dataSource: map_location_1.markerLocation }),
