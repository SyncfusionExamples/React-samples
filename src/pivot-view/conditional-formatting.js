        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section', style: { overflow: 'initial' } },
                React.createElement("div", { className: 'col-lg-9 adaptive' },
                    React.createElement(ej2_react_pivotview_1.PivotViewComponent, { id: 'PivotView', ref: function (pivotview) { _this.pivotGridObj = pivotview; }, dataSource: dataSource, showFieldList: true, width: '100%', height: '300', allowConditionalFormatting: true, gridSettings: { columnWidth: 100 } },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This sample demonstrates formatting the appearance of the pivot grid cells with values based on the applied conditions.")),
            React.createElement("div", { id: "description" },
                React.createElement("p", null,
                    ...
                    " object in the pivot grid widget along with the following properties. Both options are enabled in this sample."),
                ...
                React.createElement("p", null,
                    "The pivot grid widget features are segregated into individual modules. To enable conditional formatting, inject",
