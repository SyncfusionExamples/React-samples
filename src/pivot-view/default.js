    ...
    Default.prototype.render = function () {
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_pivotview_1.PivotViewComponent, { id: 'PivotView', dataSource: dataSource, width: '100%', height: '300', gridSettings: { columnWidth: 140 } })),
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This sample demonstrates the basic rendering of the pivotgrid widget with minimum configuration.")),
            React.createElement("div", { id: "description" },
                ...
                React.createElement("p", null, "In this demo, the pivotgrid widget is populated with its minimum default settings."))));
    };
    return Default;
