...
var Inline = (function (_super) {
    ...
    function Inline() {
        ...
        _this.template = "<p>The sample is configured with inline mode of editor. Initially, the editor is rendered without a <a href=\"https://ej2.syncfusion.com/home/\" target='_blank'>toolbar</a>. The toolbar becomes visible only when the content is selected.</p>";
        _this.inlineMode = {
            enable: true,
            onSelection: true
        };
            ...
            React.createElement("div", { className: 'control-section', id: 'rteInline' },
                React.createElement("div", { className: 'col-lg-8' },
                    React.createElement("div", { className: "content-wrapper" },
                        React.createElement(ej2_react_richtexteditor_1.RichTextEditorComponent, { id: "defaultRTE", ref: function (richtexteditor) { _this.rteObj = richtexteditor; }, valueTemplate: this.template, inlineMode: this.inlineMode, toolbarSettings: this.toolbarSettings, format: this.format, fontFamily: this.fontFamily },
