            ...
            React.createElement("div", { className: 'control-section row' },
                React.createElement("div", { className: 'col-md-8' },
                    React.createElement(ej2_react_charts_1.ChartComponent, { id: 'charts', ref: function (chart) { return _this.chartInstance = chart; }, primaryXAxis: {
                        ...
                        }, load: this.load.bind(this), title: 'Microphone Types Polar Patterns', loaded: this.onChartLoad.bind(this), tooltip: { enable: true, format: '${series.name}<br> ${point.x}: ${point.y}' } },
                        ...
                        React.createElement(ej2_react_charts_1.SeriesCollectionDirective, null,
                            React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.data1, xName: 'x', yName: 'y', name: 'Cardioid (unidirectional)', type: 'Polar', drawType: 'Spline', dashArray: '5 5 2', width: 2 }),
                            React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.data2, xName: 'x', yName: 'y', name: 'Omnidirectional', type: 'Polar', drawType: 'Spline', dashArray: '2', width: 2 }),
                            React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.data3, xName: 'x', yName: 'y', name: 'Bidirectional', type: 'Polar', drawType: 'Spline', width: 2 })))),
