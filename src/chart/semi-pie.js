        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section row' },
                React.createElement("div", { className: 'col-lg-9' },
                    React.createElement(ej2_react_charts_1.AccumulationChartComponent, { id: 'pie-chart', ref: function (pie) { return _this.pie = pie; }, title: 'Agricultural Land Percentage', enableAnimation: false, tooltip: { enable: true, format: '${point.x} : <b>${point.y}%</b>' }, legendSettings: { visible: false }, load: this.load.bind(this), loaded: this.onChartLoad.bind(this) },
                            ...
                            React.createElement("tbody", null,
                                React.createElement("tr", { style: { height: '50px' } },
                                    React.createElement("td", { style: { width: '30%' } },
                                        React.createElement("div", null, "Start Angle")),
                                    ...
                                    React.createElement("td", { style: { width: '20%' } },
                                        React.createElement("div", null,
                                            React.createElement("p", { id: "startangle", style: { fontWeight: 'normal', paddingTop: 'inherit' } }, "270")))),
                                React.createElement("tr", { style: { height: '50px' } },
                                    React.createElement("td", { style: { width: '60%' } },
                                        React.createElement("div", null, "End Angle")),
                                    ...
                                    React.createElement("td", { style: { width: '40%' } },
                                        React.createElement("div", null,
                                            React.createElement("p", { id: "endangle", style: { fontWeight: 'normal', paddingTop: 'inherit' } }, "90")))),
                                React.createElement("tr", { style: { height: '50px' } },
                                    React.createElement("td", { style: { width: '30%' } },
                                        React.createElement("div", null, "Inner Radius")),
                                    React.createElement("td", { style: { width: '50%' } },
                                        React.createElement("div", { "data-role": "rangeslider" },
                                    ...
                                    React.createElement("td", { style: { width: '40%' } },
                                        React.createElement("div", null,
                                            React.createElement("p", { id: "innerradius", style: { fontWeight: 'normal', paddingTop: 'inherit' } }, "0.40"))))))))),
