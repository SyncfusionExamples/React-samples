            ...
            React.createElement("div", { className: 'control-section' },
                ...
                React.createElement(ej2_react_charts_1.ChartComponent, { id: 'charts', style: { textAlign: "center" }, load: this.load.bind(this), primaryXAxis: {
                    ...
                    React.createElement(ej2_react_charts_1.SeriesCollectionDirective, null,
                        React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.dataManager, xName: 'Assignee', type: 'Column', yName: 'Estimate', name: 'Story Point', query: exports.query, animation: { enable: false }, marker: { dataLabel: { visible: true, position: 'Top', font: { fontWeight: '600', color: '#ffffff' } } } })))),
