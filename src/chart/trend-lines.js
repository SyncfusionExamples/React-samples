...
var Trend = (function (_super) {
    ...
    Trend.prototype.change = function (e) {
        ...
        document.getElementById('forwardForecast').disabled = this.forwardForecast;
        document.getElementById('backwardForecast').disabled = this.backwardForecast;
        document.getElementById('polynomial').disabled = this.polynomialOrder;
        document.getElementById('period').disabled = this.period;
            ...
            React.createElement("div", { className: 'control-section row' },
                React.createElement("div", { className: 'col-md-8' },
                    React.createElement(ej2_react_charts_1.ChartComponent, { id: 'charts', ref: function (chart) { return _this.chartInstance = chart; }, load: this.load.bind(this), primaryXAxis: {
                        ...
                        React.createElement(ej2_react_charts_1.Inject, { services: [ej2_react_charts_1.Category, ej2_react_charts_1.Tooltip, ej2_react_charts_1.ScatterSeries, ej2_react_charts_1.SplineSeries, ej2_react_charts_1.LineSeries, ej2_react_charts_1.Trendlines] }),
                        React.createElement(ej2_react_charts_1.SeriesCollectionDirective, null,
                            React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: series1, xName: 'x', yName: 'y', name: 'Rupees', type: 'Spline', marker: { visible: true } },
                                React.createElement(ej2_react_charts_1.TrendlinesDirective, null,
                                    React.createElement(ej2_react_charts_1.TrendlineDirective, { type: 'Linear', width: 3, marker: { visible: false }, name: 'Linear', fill: '#C64A75' })))))),
