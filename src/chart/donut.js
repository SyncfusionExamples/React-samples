        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_charts_1.AccumulationChartComponent, { id: "pie-chart", title: 'Project Cost Breakdown', legendSettings: {
                        visible: true,
                        position: 'Top'
                    }, enableSmartLabels: true, load: this.load.bind(this), tooltip: { enable: false }, loaded: this.onChartLoad.bind(this) },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This sample visualizes the project cost breakdown statistics by using doughnut series. Datalabel shows the Information about the points.")),
