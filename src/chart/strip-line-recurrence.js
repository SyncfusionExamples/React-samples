    ...
    Striplinerecurrence.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This sample visualizes the World Population Report with default column series in the chart. Data points values are showed by using data label.")),
            React.createElement("div", { id: "description" },
                React.createElement("p", null,
                    "In this example, you can see how to render and configure the recurrence stripline in chart. Striplines are used to annotate the highlighted region with some notes. You can use ",
                    React.createElement("code", null, "border"),
                    ",",
                    React.createElement("code", null, "fill"),
                    " ",
                    React.createElement("code", null, "dash-array"),
                    " properties to customize the striplines."),
                ...
                React.createElement("p", null,
                    ...
                    React.createElement("code", null, "Strpline"),
                    " module using ",
                    React.createElement("code", null, "Chart.Inject(Strpline)"),
                    " method."),
                React.createElement("p", null,
