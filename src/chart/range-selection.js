            ...
            React.createElement("div", { className: 'control-section row' },
                React.createElement("div", { className: 'col-md-8' },
                    React.createElement(ej2_react_charts_1.ChartComponent, { id: 'charts', ref: function (chart) { return _this.chartInstance = chart; }, primaryXAxis: {
                            ...
                            maximum: 100,
                            majorGridLines: { width: 0 }
                        }, chartArea: { border: { width: 0 } }, legendSettings: { visible: true, toggleVisibility: false }, title: 'Profit Comparision of A and B', loaded: this.onChartLoad.bind(this), selectionMode: 'None', load: this.load.bind(this) },
