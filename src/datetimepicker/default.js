    ...
    Default.prototype.render = function () {
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "The following sample demonstrates the default functionalities of the DateTimePicker. Enter the value in input text box or click the date and time icon to select the desired value. ")),
            React.createElement("div", { id: 'description' },
                ...
                React.createElement("p", null,
                    ...
                    React.createElement("a", { href: "https://ej2.syncfusion.com/react/documentation/datetimepicker/getting-started.html", target: "_blank" }, " documentation section"),
                    "."))));
    };
    return Default;
