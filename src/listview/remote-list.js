    ...
    Remote.prototype.render = function () {
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_lists_1.ListViewComponent, { id: 'remote-list', dataSource: this.dataSource, fields: this.fields, query: this.query, headerTitle: 'Products', showHeader: true })),
