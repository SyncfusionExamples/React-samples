    ...
    Template.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_lists_1.ListViewComponent, { id: 'listview_template', dataSource: newsData_1.dataSource, headerTitle: 'Syncfusion Blog', showHeader: true, cssClass: 'e-list-template', actionComplete: this.onComplete.bind(this), template: this.listTemplate, ref: function (listview) { _this.listviewInstance = listview; } })),
