...
var Data = (function (_super) {
    ...
    function Data() {
        ...
        _this.query = new ej2_data_1.Query().select(['ProductID', 'ProductName']);
        // map the appropriate columns to remote data fields property
        _this.remoteFields = { value: 'ProductName' };
                ...
                React.createElement("div", { className: 'col-lg-9' },
                    ...
                    React.createElement("div", { className: 'col-lg-6' },
                        React.createElement("div", { id: "remote" },
                            ...
                            React.createElement(ej2_react_dropdowns_1.AutoCompleteComponent, { id: "products", dataSource: this.productData, query: this.query, ref: function (autocomplete) { _this.remoteDataObj = autocomplete; }, sortOrder: "Ascending", fields: this.remoteFields, autofill: true, placeholder: "e.g. Alice Mutton", suggestionCount: 5, filterType: 'StartsWith' })))),
