...
var Positions = (function (_super) {
    ...
    Positions.prototype.setcustomPosValue = function () {
        ...
        this.toastObj.position.X = parseInt(document.getElementById('xPos').value, 10);
        this.toastObj.position.Y = parseInt(document.getElementById('yPos').value, 10);
    };
    ...
    Positions.prototype.onclose = function (e) {
        var btnEleHide = document.getElementById('hideTosat');
    ...
    Positions.prototype.render = function () {
        ...
        document.addEventListener('click', function (e) {
            ...
            if (!ej2_base_1.isNullOrUndefined(this.toastObj) && e.target !== btnEle && this.toastObj.target === document.body) {
                this.toastObj.hide('All');
            }
        }.bind(this));
                ...
                React.createElement("div", { className: "e-sample-resize-container", id: "toast_pos_target" },
                    ...
                    React.createElement("div", { id: "toast_pos_property" },
                        ...
                        React.createElement("div", { id: "dropdownChoose" },
                            React.createElement("div", { id: "dropdown", style: { 'padding-top': '25px' } },
                        ...
                        React.createElement("table", { style: { 'width': '100%' } },
                            React.createElement("tbody", null,
                                React.createElement("tr", null,
                                    React.createElement("td", { id: "customChoose", style: { 'display': 'none' } },
                                        React.createElement("form", { id: "formId", className: "form-horizontal" },
                                            React.createElement("div", { className: "e-row" },
                                                React.createElement("div", { className: "e-float-input" },
                                                    React.createElement("input", { className: "e-input", id: "xPos", name: "Digits", defaultValue: "50", required: true }),
                                                    React.createElement("span", { className: "e-float-line" }),
                                                    React.createElement("label", { className: "e-float-text" }, "X Position"))),
                                            React.createElement("div", { className: "e-row" },
                                                React.createElement("div", { className: "e-float-input" },
                                                    React.createElement("input", { className: "e-input", id: "yPos", name: "Digits", defaultValue: "50", required: true }),
                                                    React.createElement("span", { className: "e-float-line" }),
                        ...
                        React.createElement("div", { id: "toast_btn", style: { 'padding-top': '25px' } },
                            React.createElement(ej2_react_buttons_1.ButtonComponent, { className: "e-btn e-control", id: 'show_Toast', style: { 'margin-right': '15px' }, onClick: this.showBtnClick.bind(this) }, "Show Toasts"),
                            React.createElement(ej2_react_buttons_1.ButtonComponent, { className: "e-btn e-control", id: 'hideTosat', onClick: this.hideBtnClick.bind(this) }, "Hide All"))))),
